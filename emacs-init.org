...
TODO: add icons for marginalia
TODO: fix consult search
...
**** The =detvdl-emacs-ef-themes.el= module
:PROPERTIES:
...
Note that the ~detvdl-emacs-comment~ is there for my testing purposes
([[#h:3b14faa6-83fd-4d5f-b3bc-85f72fd572d4][The =init.el= macro to do nothing with Elisp code (~detvdl-emacs-comment~)]]).

#+begin_src emacs-lisp :tangle "detvdl-emacs-modules/detvdl-emacs-ef-themes.el"
;;; The Ef (εὖ) themes
...
**** The =detvdl-emacs-doric-themes.el= module
:PROPERTIES:
...
package ([[#h:2b2a27a1-6d2e-4b59-bf60-94682e173f2f][The =detvdl-emacs-ef-themes.el= module]]). For something
in-between, which I would consider the best "default theme" for a text
editor, opt for my ~modus-themes~ ([[#h:36af519a-67e1-42b6-a38a-2052638108f9][The =detvdl-emacs-modus-themes.el= module]]).
...
#+begin_src emacs-lisp :tangle "detvdl-emacs-modules/detvdl-emacs-doric-themes.el"
;;; The Doric themes
...
**** The =detvdl-emacs-standard-themes.el= module
:PROPERTIES:
...
#+begin_src emacs-lisp :tangle "detvdl-emacs-modules/detvdl-emacs-standard-themes.el"
;;; The Standard themes
...
*** The =detvdl-emacs-essentials.el= section for comments
:PROPERTIES:
...
*** The =detvdl-emacs-window.el= keys for window motions (~windmove~)
:PROPERTIES:
...
#+end_src
*** The =detvdl-emacs-org.el= Org Tempo settings

Org-tempo is an org-mode internal library that allows expansion of
structure templates by simply inserting ~<~ followed by a template
into the buffer, and pressing =<TAB>=
...
#+begin_src emacs-lisp :tangle "detvdl-lisp/prot-org.el" :mkdirp yes
