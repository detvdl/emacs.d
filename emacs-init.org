...
shell buffers ([[#h:581aa0ff-b136-4099-a321-3b86edbfbccb][The =detvdl-emacs-essentials.el= settings for bookmarks]]).
...
=highlight-indent-guides= provides a visual indentation indicator for indent-heavy programming languages such as Python
#+begin_src emacs-lisp :tangle "detvdl-emacs-modules/detvdl-emacs-langs.el"
