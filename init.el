...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (git-gutter-fringe emacs-git-gutter-fringe markdown-mode elisp-slime-nav js2-mode rainbow-mode projectile-ripgrep company-anaconda pyenv-mode cider rainbow-delimiters drag-stuff use-package))))
(custom-set-faces
