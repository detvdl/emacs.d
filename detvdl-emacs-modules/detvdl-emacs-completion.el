...
(use-package minibuffer
  ...
  (unless detvdl-emacs-completion-ui
    (detvdl-emacs-keybind minibuffer-local-completion-map
      "<up>" #'minibuffer-previous-line-completion
      "<down>" #'minibuffer-next-line-completion)

    (detvdl-emacs-keybind completion-in-region-mode-map
...
(use-package abbrev
  ...
  (detvdl-emacs-abbrev global-abbrev-table
  ...
  (detvdl-emacs-abbrev text-mode-abbrev-table
    "asciidoc"       "AsciiDoc"
    "auctex"         "AUCTeX"
    "cafe"           "café"
    "cliche"         "cliché"
  ...
  (with-eval-after-load 'org
    (detvdl-emacs-abbrev org-mode-abbrev-table
  ...
  (with-eval-after-load 'message
    (detvdl-emacs-abbrev message-mode-abbrev-table
...
Development continues on GitHub with GitLab as a mirror."))
  ...
  ;; The `detvdl-emacs-abbrev' macro, which simplifies how we use
...
(when detvdl-emacs-completion-ui
  (use-package corfu
    :ensure t
...
(when detvdl-emacs-completion-ui
  (require
   (pcase detvdl-emacs-completion-ui
     ('vertico 'detvdl-emacs-vertico))))

(provide 'detvdl-emacs-completion)
