  ...
  (apply 'custom-theme-set-faces 'eclipse
         (mapcar
          ...
          `((default :foreground ,eclipse-fg :background ,eclipse-bg)
            ...
            (term)
            (dired-subtree-depth-1-face :background "grey60")
            (dired-subtree-depth-2-face :background "grey60")
            (dired-subtree-depth-3-face :background "grey60")
            (dired-subtree-depth-4-face :background "grey60")
            (dired-subtree-depth-5-face :background "grey60")
            (dired-subtree-depth-6-face :background "grey60")
...
>>>>>>> chore: minor stuff & things
            ...
            (diff-added :background "#c0e0c0")
            (diff-removed :background "#f4d4d4")
            (magit-tag :background "LemonChiffon1" :foreground "goldenrod4")
            (magit-section-heading :inherit header-line)
            (magit-section-highlight :weight medium)
            (magit-diff-context :foreground "grey20")
            (magit-diff-context-highlight :weight medium :foreground "grey20")
            (magit-diff-added :inherit diff-added)
            (magit-diff-added-highlight :inherit diff-added :weight medium)
            (magit-diff-removed :inherit diff-removed)
            (magit-diff-removed-highlight :inherit diff-removed :weight medium)
            (magit-diff-file-heading)
            (magit-diff-file-heading-highlight :weight medium)
            (magit-diff-file-heading-selection :foreground "red")
            (magit-diff-hunk-heading :inherit diff-hunk-header)
            (magit-diff-hunk-heading-highlight :inherit diff-hunk-header :weight medium)
